...
class HomeTop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: SafeArea(
        ...
        children: <Widget>[buildWelcomeMessage(), buildCircleProfileContainer(), CategoryView()],
      )),
    );
  }
  ...
  Container buildCircleProfileContainer() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(image: AssetImage('images/perfil.jpg'), fit: BoxFit.cover),
      ),
  ...
  Container buildCircleNotificationContainer() {
    return Container(
      ...
      decoration: BoxDecoration(shape: BoxShape.circle, color: Color.fromRGBO(80, 210, 194, 0.8)),
      margin: EdgeInsets.only(left: 80),
      child: Center(
        child: Text(
          '7',
          style: TextStyle(
              fontSize: containerGrowAnimation.value * 17, fontWeight: FontWeight.w200, color: Colors.white70),
        ),
      ),
    );
  }
